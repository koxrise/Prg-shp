...
function navigate(screenName, push = true) {
  ...
  if (push) {
    ...
    if (last !== screenName) state.history.push(screenName);
  }
...
function updateBackButton() {
  ...
  if (localBtn) localBtn.classList.toggle("hidden", !show);
...
function renderCart() {
  ...
  if (localSubmitBtn) localSubmitBtn.addEventListener("click", submitCartOrder);
...
function bindEvents() {
  ...
  if (localBackBtn) localBackBtn.addEventListener("click", goBack);

  const cartFab = document.getElementById("cartFab");
  if (cartFab) cartFab.addEventListener("click", () => navigate("cart"));

  const customSubmitBtn = document.getElementById("customSubmitBtn");
  if (customSubmitBtn) customSubmitBtn.addEventListener("click", submitCustomOrder);
}
